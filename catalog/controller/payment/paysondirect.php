...
class ControllerPaymentPaysondirect extends Controller {
    ...
    private function handlePaymentDetails($paymentDetails, $orderId = 0, $ipnCall = false) {
        ...
        if (($paymentType == "INVOICE" || $paymentType == "TRANSFER") && ($transferStatus == "ERROR"||$transferStatus == "DENIED"||$transferStatus == "EXPIRED")){
            if ($ipnCall)
    ...
    private function getOrderItems() {
        ...
        foreach ($orderTotals as $orderTotal) {
            ...
            if($orderTotalAmount == null || $orderTotalAmount == 0){ break; }
